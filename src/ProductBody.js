    ...
    <div className="product-body-container">
      ...
      <div className="product-description-price">
        ...
        <span className="product-description-price-old">
          £{((props.price / props.reduced.percentage) * 100).toFixed(2)}{" "}
        </span>
      </div>
      ...
      <div>
        <button className="product-body-addtocart" onClick={()=>props.addToCart(props.item,qty)} disabled={qty<=0?true:false}>
